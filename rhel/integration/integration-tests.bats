...
@test "integration-good-path-appsody-init-nodejs-express" {
    ...
    run timeout 1h $APPSODY init dev.local/nodejs-express
...
@test "integration-good-path-appsody-init-nodejs-loopback" {
    ...
    run timeout 1h $APPSODY init dev.local/nodejs-loopback
...
@test "integration-good-path-appsody-init-java-microprofile" {
    ...
    run timeout 1h $APPSODY init dev.local/java-microprofile
...
@test "integration-good-path-appsody-init-java-spring-boot2" {
    ...
    run timeout 1h $APPSODY init dev.local/java-spring-boot2
...
@test "integration-good-path-appsody-init-kitura" {
    ...
    cd $TEMPDIR/kitura
    run timeout 1h $APPSODY init dev.local/kitura
...
@test "integration-good-path-appsody-init-swift" {
    ...
    cd $TEMPDIR/swift
    run timeout 1h $APPSODY init dev.local/swift
...
@test "integration-good-path-appsody-init-python-flask" {
    ...
    run timeout 1h $APPSODY init dev.local/python-flask
...
@test "integration-good-path-appsody-init-starter" {
    ...
    cd $TEMPDIR/starter
    run timeout 1h $APPSODY init dev.local/starter
